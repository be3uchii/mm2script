...
local function createTransparencyButton(parent, text, values, defaultValueIndex, callback)
    ...
    transparencyFrame.Size = UDim2.new(1, -8, 0, 20)
    transparencyFrame.BackgroundTransparency = 1
    transparencyFrame.Position = UDim2.new(0, 4, 0, 0)
    ...
    prevButton.TextSize = 10
    prevButton.Font = Enum.Font.GothamBold
    prevButton.Parent = transparencyFrame
    local DaarnaastButton = Instance.new("TextButton")
    nextButton.Size = UDim2.new(0.1, 0, 0.8, 0)
    nextButton.Position = UDim2.new(0.85, 0, 0.1, 0)
    nextButton.BackgroundColor3 = Color3.fromRGB(30, 30, 40)
    nextButton.Text = ">"
