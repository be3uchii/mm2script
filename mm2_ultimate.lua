...
local function animateLoading()
    ...
    while tick() - startTime < duration do
        ...
        TweenService:Create(LoadingText, TweenInfo.new(0.8, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {TextTransparency = 0.3 + 0.7 * (1 - progress)}):Play()
        wait(0.1)
    end
...
-- Инициализация GUI во время загрузки
local function initializeGUI()
    ...
    -- Показать MainFrame после загрузки
