...
local minimizedPosition = UDim2.new(0.5, -42.5, 0, 12)
...
local function createCleanToggle(parent, text, value, callback, id)
    ...
    SwitchButton.Size = UDim2.new(0.25, 0, 0.55, 0)
    SwitchButton.Position = UDim2.new(0.7, 0, 0.225, 0)
    SwitchButton.BackgroundColor3 = value and Color3.fromRGB(52, 199, 89) or Color3.fromRGB(44, 44, 46)
    ...
    ToggleCircle.Position = value and UDim2.new(1, -22, 0.5, -10) or UDim2.new(0, 2, 0.5, -10)
    ...
    uiStroke.Transparency = value and 1 or 0.5
    uiStroke.Parent = SwitchButton
    
    SwitchButton.MouseButton1Click:Connect(function()
        playSound()
        value = not value
        
        local circleGoalPos = value and UDim2.new(1, -22, 0.5, -10) or UDim2.new(0, 2, 0.5, -10)
        local bgGoalColor = value and Color3.fromRGB(52, 199, 89) or Color3.fromRGB(44, 44, 46)
        
        local tweenInfo = TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
        
        local tween1 = TweenService:Create(ToggleCircle, tweenInfo, {Position = circleGoalPos})
        local tween2 = TweenService:Create(SwitchButton, tweenInfo, {BackgroundColor3 = bgGoalColor})
        local tween3 = TweenService:Create(uiStroke, tweenInfo, {Transparency = value and 1 or 0.5})
...
local function createValueChanger(parent, text, values, value, callback, id)
    ...
    valueFrame.BackgroundColor3 = Color3.fromRGB(44, 44, 46)
...
local function createMainGUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabButton.BackgroundColor3 = i == currentTab and Color3.fromRGB(60, 60, 80) or Color3.fromRGB(44, 44, 46)
        ...
        tabIcon.Size = i == 1 and UDim2.new(0, 27, 0, 27) or UDim2.new(0, 20, 0, 20)
        tabIcon.Position = i == 1 and UDim2.new(0.5, -13.5, 0.5, -13.5) or UDim2.new(0.5, -10, 0.5, -10)
        ...
        contentFrame.BackgroundColor3 = Color3.fromRGB(28, 28, 30)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for j, btn in ipairs(tabButtons) do
                btn.BackgroundColor3 = j == currentTab and Color3.fromRGB(60, 60, 80) or Color3.fromRGB(44, 44, 46)
            end
