...
local function createColorButton(parent, text, value, callback, id)
    ...
    local hoverTween = TweenService:Create(colorButton, TweenInfo.new(0.1), {Size = UDim2.new(0.25, 0, 0.9, 0)})
    ...
    colorButton.MouseLeave:Connect(function()
        TweenService:Create(colorButton, TweenInfo.new(0.1), {Size = UDim2.new(0.25, 0, 0.8, 0)}):Play()
    end)
...
local function refreshConfigUI(scrollFrame)
    ...
    local hoverTween = TweenService:Create(createButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(70, 70, 90)})
    ...
    createButton.MouseLeave:Connect(function()
        TweenService:Create(createButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(60, 60, 80)}):Play()
    end)
    ...
    for _, configName in ipairs(scanConfigs()) do
        ...
        local loadHover = TweenService:Create(loadButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(70, 70, 90)})
        local deleteHover = TweenService:Create(deleteButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(90, 40, 40)})
        ...
        loadButton.MouseLeave:Connect(function()
            TweenService:Create(loadButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(60, 60, 80)}):Play()
        end)
        ...
        deleteButton.MouseLeave:Connect(function()
            TweenService:Create(deleteButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(80, 30, 30)}):Play()
        end)
