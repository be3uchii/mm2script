...
local function updateHitbox(character)
    ...
    if not hitboxCache[character] then
        ...
        if settings.Combat.Hitbox.Type == "Sphere" then
            ...
            box.Radius = settings.Combat.Hitbox.Size * 1.3
        else
            box = Instance.new("BoxHandleAdornment")
            box.Size = Vector3.new(settings.Combat.Hitbox.Size * 1.6, settings.Combat.Hitbox.Size * 1.9, settings.Combat.Hitbox.Size * 1.6)
        end
    ...
    if settings.Combat.Hitbox.Type == "Sphere" then
        hrp.Size = Vector3.new(settings.Combat.Hitbox.Size * 1.3, settings.Combat.Hitbox.Size * 1.3, settings.Combat.Hitbox.Size * 1.3)
    else
        hrp.Size = Vector3.new(settings.Combat.Hitbox.Size * 1.6, settings.Combat.Hitbox.Size * 1.9, settings.Combat.Hitbox.Size * 1.6)
    end
...
for i, tabName in ipairs(tabs) do
    ...
    tabButton.BackgroundColor3 = i == currentTab and Color3.fromRGB(70, 70, 90) or Color3.fromRGB(45, 45, 60)
    ...
    tabButton.MouseButton1Click:Connect(function()
        ...
        for j, btn in ipairs(tabButtons) do
            btn.BackgroundColor3 = j == currentTab and Color3.fromRGB(70, 70, 90) or Color3.fromRGB(45, 45, 60)
        end
    end)
end
