...
local function updateHitbox(player)
    ...
    if onScreen then
        ...
        local raycastResult = workspace:Raycast(workspace.CurrentCamera.CFrame.Position, (rootPart.Position - workspace.CurrentCamera.CFrame.Position).Unit * distance, raycastParams)
