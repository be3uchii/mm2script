...
local minimizedPosition = UDim2.new(0.5, -35, 0, 5)
...
local defaultSettings = {
    PlayerInfo = {
        ...
        FollowUserId = LocalPlayer.FollowUserId,
        Team = LocalPlayer.Team and LocalPlayer.Team.Name or "None",
        Platform = LocalPlayer:GetNetworkPing() > 0 and "Mobile" or "PC"
    },
    Combat = {
        Hitbox = {
            Enabled = false,
...
local function createMainGUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        contentFrame.Size = UDim2.new(1, -8, 1, -42)
        contentFrame.Position = UDim2.new(0, 4, 0, 42)
