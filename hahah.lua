...
local function createToggle(parent, text, defaultValue, callback)
    ...
    toggle.BackgroundColor3 = defaultValue and Color3.fromRGB(0, 255, 100) or Color3.fromRGB(255, 50, 50)
    ...
    toggle.MouseButton1Click:Connect(function()
        ...
        toggle.Text = defaultValue and "ON" or "OFF"
        toggle.BackgroundColor3 = defaultValue and Color3.fromRGB(0, 255, 100) or Color3.fromRGB(255, 50, 50)
        local tween = TweenService:Create(toggle, tweenInfo, {BackgroundColor3 = defaultValue and Color3.fromRGB(0, 255, 100) or Color3.fromRGB(255, 50, 50)})
        tween:Play()
...
local function createValueChanger(parent, text, values, defaultValueIndex, callback)
    ...
    local function updateValue()
        ...
        local tween = TweenService:Create(valueLabel, tweenInfo, {TextColor3 = Color3.fromRGB(0, 255, 100)})
        tween:Play()
        wait(0.3)
        tween = TweenService:Create(valueLabel, tweenInfo, {TextColor3 = Color3.fromRGB(255, 255, 255)})
        tween:Play()
    end
...
local function updateHighlight(character)
    if not settings.ESP.Highlight then return end
    ...
    if not highlightCache[character] then
...
for i, tabName in ipairs(tabs) do
    ...
    tabButton.BackgroundColor3 = i == currentTab and Color3.fromRGB(80, 80, 100) or Color3.fromRGB(30, 30, 50)
    ...
    elseif tabName == "ESP" then
        ...
        createToggle(scrollFrame, "Highlight", settings.ESP.Highlight, function(value)
    ...
    tabButton.MouseButton1Click:Connect(function()
        ...
        for j, btn in ipairs(tabButtons) do
            local targetColor = j == currentTab and Color3.fromRGB(80, 80, 100) or Color3.fromRGB(30, 30, 50)
