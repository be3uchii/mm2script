...
if PlayerGui:FindFirstChild("TestMenuGui") then PlayerGui.TestMenuGui:Destroy() end
        ...
        if not hitboxParts[player] then
            ...
            for _, part in pairs(player.Character:GetDescendants()) do
                if part:IsA("BasePart") then
                    ...
                    table.insert(hitboxParts[player], part)
                end
            end
        end
    end
...
local function updateESP()
    ...
    local function applyESP(player)
        ...
        if not espBoxes[player] then
            ...
            box.ZIndex = 10
            box.Size = humanoidRootPart.Size * 1.2
...
for i, tabName in ipairs(tabs) do
    ...
    elseif tabName == "ESP" then
        ...
        createToggle(scrollFrame, "Игнорировать тиммейтов", settings.ESP.TeamCheck, function(value)
