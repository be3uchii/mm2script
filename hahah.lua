...
local function refreshESPUI()
    ...
    local distanceValues = {50, 100, 200, 300, 500}
...
local function refreshConfigUI()
    ...
    configListFrame.Position = UDim2.new(0, 4, 0, 70)
    ...
    for _, configName in ipairs(configs) do
        ...
        configButton.Position = UDim2.new(0, 0, 0, yOffset)
    ...
    saveButton.Size = UDim2.new(1, -8, 0, 25)
    saveButton.Position = UDim2.new(0, 4, 0, yOffset + 5)
    saveButton.BackgroundColor3 = Color3.fromRGB(76, 217, 100)
    saveButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    saveButton.Text = "Save Current Config"
    ...
    local glow = Instance.new("UIStroke")
    glow.Color = Color3.fromRGB(60, 255, 60)
    glow.Thickness = 1
    glow.Transparency = 0.7
    glow.Parent = saveButton
    
    saveButton.MouseButton1Click:Connect(function()
        playSound()
        local configName = os.date("%Y%m%d_%H%M%S")
...
local function createUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for j, button in ipairs(tabButtons) do
                button.TextColor3 = j == currentTab and Color3.fromRGB(60, 60, 255) or Color3.fromRGB(150, 150, 150)
            end
    ...
    connections.headerDrag = headerFrame.InputBegan:Connect(function(input)
