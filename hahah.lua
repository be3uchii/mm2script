    ...
    for _, connection in ipairs(skeletonConnections) do
        ...
        if part1 and part2 then
            ...
            if onScreen1 and onScreen2 then
                ...
                line.Visible = settings.ESP.ShowSkeleton
                line.Color = Color3.fromRGB(255, 255, 255)
                line.Thickness = 1
                line.Transparency = 0.8
            else
...
local function refreshESPUI()
    ...
    createCleanToggle(espScrollFrame, "Show Skeleton", settings.ESP.ShowSkeleton, function(value)
...
local function refreshMusicUI()
    ...
    trackLabel.Size = UDim2.new(1, -8, 0, 18)
    ...
    sliderFrame.Size = UDim2.new(1, -8, 0, 8)
    sliderFrame.Position = UDim2.new(0, 4, 0, 20)
    ...
    timeLabel.Position = UDim2.new(0, 4, 0, 35)
    ...
    controlsFrame.Position = UDim2.new(0, 4, 0, 55)
    ...
    prevButton.Position = UDim2.new(0.25, -12.5, 0, 5)
    prevButton.BackgroundTransparency = 1
    ...
    playPauseButton.Position = UDim2.new(0.5, -12.5, 0, 5)
    ...
    nextButton.Position = UDim2.new(0.75, -12.5, 0, 5)
    nextButton.BackgroundTransparency = 1
    ...
    volumeChanger.Position = UDim2.new(0, 4, 0, 95)
        ...
        loadButton.MouseButton1Click:Connect(function()
            ...
            if loadConfig(configName) then
                for id, element in pairs(uiElements) do
                    ...
                    elseif id == "espShowSkeleton" then
                        element.update(settings.ESP.ShowSkeleton)
...
local function createMainGUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = UDim2.new(0, i == 1 and 17 or 15, 0, i == 1 and 17 or 15)
        tabIcon.Position = UDim2.new(0.5, i == 1 and -8.5 or -7.5, 0.5, i == 1 and -8.5 or -7.5)
