...
local function saveSettings()
    ...
    writefile("Delta/SilenceSettings.json", data)
end

local function loadSettings()
    if isfolder("Delta") and isfile("Delta/SilenceSettings.json") then
        local success, result = pcall(function()
            local data = readfile("Delta/SilenceSettings.json")
...
for i, tabName in ipairs(tabs) do
    ...
    elseif tabName == "ESP" then
        ...
        createValueChanger(scrollFrame, "ESP Transparency", transparencies, table.find(transparencies, settings.ESP.Transparency) or 7, function(value)
