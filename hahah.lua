...
local minimizedPosition = UDim2.new(0.5, -40, 0.02, 0)
...
local function createMainGUI()
    ...
    leftIcon.Image = "rbxassetid://70459115196971"
    leftIcon.Size = isMinimized and UDim2.new(0, 16, 0, 16) or UDim2.new(0, 18, 0, 18)
    leftIcon.Position = isMinimized and UDim2.new(0.5, -45, 0.5, -8) or UDim2.new(0.5, -60, 0.5, -9)
    leftIcon.BackgroundTransparency = 1
    leftIcon.ImageTransparency = 0.1
    leftIcon.Parent = dragArea

    local rightIcon = Instance.new("ImageLabel")
    rightIcon.Name = "RightIcon"
    rightIcon.Image = "rbxassetid://70459115196971"
    rightIcon.Size = isMinimized and UDim2.new(0, 16, 0, 16) or UDim2.new(0, 18, 0, 18)
    rightIcon.Position = isMinimized and UDim2.new(0.5, 25, 0.5, -8) or UDim2.new(0.5, 35, 0.5, -9)
    ...
    local lastUpdate = 0
    connections.RenderStep = RunService.RenderStepped:Connect(function(delta)
        if isVisible then
            local now = os.clock()
