...
local function createCleanToggle(parent, text, value, callback, id)
    ...
    ToggleCircle.Position = value and UDim2.new(1, -20, 0.5, -9) or UDim2.new(0, 2, 0.5, -9)
    ...
    SwitchButton.MouseButton1Click:Connect(function()
        ...
        local circleGoalPos = value and UDim2.new(1, -20, 0.5, -9) or UDim2.new(0, 2, 0.5, -9)
...
local function createMainGUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = i == 1 and UDim2.new(0, 25, 0, 25) or UDim2.new(0, 18, 0, 18)
        tabIcon.Position = i == 1 and UDim2.new(0.5, -12.5, 0.5, -12.5) or UDim2.new(0.5, -9, 0.5, -9)
