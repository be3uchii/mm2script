...
local function createMainGUI()
    ...
    rightIcon.Position = UDim2.new(0.5, 40, 0.5, -12)
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = i == 1 and UDim2.new(0, 24, 0, 24) or UDim2.new(0, 20, 0, 20)
        tabIcon.Position = i == 1 and UDim2.new(0.5, -12, 0.5, -12) or UDim2.new(0.5, -10, 0.5, -10)
