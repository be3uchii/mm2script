...
local function createMainGUI()
    ...
    icon.Name = "MenuIcon"
    icon.Image = "rbxassetid://70459115196971"
    icon.Size = isMinimized and UDim2.new(0, 14, 0, 14) or UDim2.new(0, 16, 0, 16)
    icon.Position = isMinimized and UDim2.new(0.5, 25, 0.5, -7) or UDim2.new(0.5, 35, 0.5, -8)
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = i == 1 and UDim2.new(0, 16, 0, 16) or UDim2.new(0, 12, 0, 12)
        tabIcon.Position = i == 1 and UDim2.new(0.5, -8, 0.5, -8) or UDim2.new(0.5, -6, 0.5, -6)
