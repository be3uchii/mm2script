...
local function createCleanToggle(parent, text, value, callback, id)
    ...
    toggleFrame.Size = UDim2.new(1, -8, 0, 34)
    ...
    SwitchButton.Size = UDim2.new(0.3, 0, 0.8, 0)
    SwitchButton.Position = UDim2.new(0.7, 0, 0.1, 0)
    ...
    ToggleCircle.Position = value and UDim2.new(1, -24, 0.5, -11) or UDim2.new(0, 2, 0.5, -11)
    ...
    SwitchButton.MouseButton1Click:Connect(function()
        ...
        local circleGoalPos = value and UDim2.new(1, -24, 0.5, -11) or UDim2.new(0, 2, 0.5, -11)
...
local function createMainGUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = i == 1 and UDim2.new(0, 23, 0, 23) or UDim2.new(0, 18, 0, 18)
        tabIcon.Position = i == 1 and UDim2.new(0.5, -11.5, 0.5, -11.5) or UDim2.new(0.5, -9, 0.5, -9)
