...
local function createMainGUI()
    ...
    tabContainer.Size = UDim2.new(0, 60, 1, -24)
    tabContainer.Position = UDim2.new(0, 4, 0, 24)
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabButton.Position = UDim2.new(0, 2, 0, (i-1)*44)
        ...
        contentFrame.Size = UDim2.new(1, -68, 1, -52)
        contentFrame.Position = UDim2.new(0, 64, 0, 52)
