...
local function playSound()
    if not soundCache.clickSound then
        ...
        soundCache.clickSound.SoundId = "rbxassetid://6042053626"
        soundCache.clickSound.Volume = 0.1
...
local function setupMusic()
    if not musicSound then
        ...
        musicSound.SoundId = "rbxassetid://5409360995"
        musicSound.Volume = 0.7
        musicSound.Looped = true
        musicSound.Parent = workspace
    end
    
    if settings.PlayerInfo.MusicEnabled == nil then
        local musicPopup = Instance.new("Frame")
        musicPopup.Size = UDim2.new(0, 200, 0, 120)
        musicPopup.Position = UDim2.new(0.5, -100, 0.5, -60)
        musicPopup.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
        musicPopup.BackgroundTransparency = 0.1
        musicPopup.BorderSizePixel = 0
        musicPopup.Parent = PlayerGui
        
        local corner = Instance.new("UICorner")
        corner.CornerRadius = UDim.new(0, 8)
        corner.Parent = musicPopup
        
        local stroke = Instance.new("UIStroke")
        stroke.Color = Color3.fromRGB(60, 60, 255)
        stroke.Thickness = 2
        stroke.Transparency = 0.1
        stroke.Parent = musicPopup
        
        local label = Instance.new("TextLabel")
        label.Size = UDim2.new(1, -20, 0, 40)
        label.Position = UDim2.new(0, 10, 0, 10)
        label.BackgroundTransparency = 1
        label.Text = "Включить музыку?"
        label.TextColor3 = Color3.fromRGB(230, 230, 230)
        label.TextSize = 14
        label.Font = Enum.Font.GothamBold
        label.Parent = musicPopup
        
        local yesButton = Instance.new("TextButton")
        yesButton.Size = UDim2.new(0.8, 0, 0, 30)
        yesButton.Position = UDim2.new(0.1, 0, 0, 60)
        yesButton.BackgroundColor3 = Color3.fromRGB(60, 60, 80)
        yesButton.Text = "Да"
        yesButton.TextColor3 = Color3.fromRGB(230, 230, 230)
        yesButton.Parent = musicPopup
        
        local noButton = Instance.new("TextButton")
        noButton.Size = UDim2.new(0.8, 0, 0, 30)
        noButton.Position = UDim2.new(0.1, 0, 0, 95)
        noButton.BackgroundColor3 = Color3.fromRGB(60, 60, 80)
        noButton.Text = "Нет"
        noButton.TextColor3 = Color3.fromRGB(230, 230, 230)
        noButton.Parent = musicPopup
        
        corner:Clone().Parent = yesButton
        corner:Clone().Parent = noButton
        
        yesButton.MouseButton1Click:Connect(function()
            playSound()
            settings.PlayerInfo.MusicEnabled = true
            musicSound:Play()
            musicPopup:Destroy()
            saveSettings()
        end)
        ...
        noButton.MouseButton1Click:Connect(function()
            playSound()
            settings.PlayerInfo.MusicEnabled = false
            musicPopup:Destroy()
            saveSettings()
        end)
    elseif settings.PlayerInfo.MusicEnabled then
        musicSound:Play()
    end
end
...
local function loadSettings()
    ...
    if isfile(path) then
        ...
        if success and result and result.PlayerInfo then
            settings.PlayerInfo = result.PlayerInfo
        end
    end
end
...
local function refreshCombatUI()
    ...
    tabIcon.Position = UDim2.new(0, 5, 0, 4)
    tabIcon.BackgroundTransparency = 1
    tabIcon.Image = "rbxassetid://12619379348"
    tabIcon.Parent = tabButtons[1]
...
local function refreshESPUI()
    ...
    tabIcon.Position = UDim2.new(0, 5, 0, 4)
    tabIcon.BackgroundTransparency = 1
    tabIcon.Image = "rbxassetid://6523858394"
    tabIcon.Parent = tabButtons[2]
...
local function refreshConfigUI(scrollFrame)
    ...
    tabIcon.Position = UDim2.new(0, 5, 0, 4)
    tabIcon.BackgroundTransparency = 1
    tabIcon.Image = "rbxassetid://7059346373"
    tabIcon.Parent = tabButtons[3]
