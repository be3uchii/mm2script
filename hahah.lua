...
local function playLoadSound()
    if not soundCache.loadSound then
        soundCache.loadSound = Instance.new("Sound")
        soundCache.loadSound.SoundId = "rbxassetid://18962645622"
        soundCache.loadSound.Volume = 0.15
        soundCache.loadSound.Parent = workspace
    end
    soundCache.loadSound:Play()
end
...
game:BindToClose(function()
    ...
    if soundCache.loadSound then
        soundCache.loadSound:Stop()
        soundCache.loadSound:Destroy()
    end
end)