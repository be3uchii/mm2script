...
local minimizedPosition = UDim2.new(0.5, -50, 0, 20)
...
local defaultSettings = {
    PlayerInfo = {
        ...
        Platform = UserInputService:GetPlatform() == Enum.Platform.Windows and "PC" or "Mobile"
    },
    Combat = {
        Hitbox = {
            Enabled = false,
...
local function createCleanToggle(parent, text, value, callback, id)
    ...
    hoverEffect.Parent = SwitchButton
    hoverEffect.Visible = false
    
    SwitchButton.MouseEnter:Connect(function()
        hoverEffect.Visible = true
        TweenService:Create(hoverEffect, TweenInfo.new(0.15), {BackgroundTransparency = 0.8}):Play()
    end)
    
    SwitchButton.MouseLeave:Connect(function()
        TweenService:Create(hoverEffect, TweenInfo.new(0.15), {BackgroundTransparency = 0.9}):Play()
        wait(0.15)
        hoverEffect.Visible = false
    end)
    ...
    SwitchButton.MouseButton1Click:Connect(function()
        ...
        local circleGoalPos = value and UDim2.new(1, -18, 0.5, -8) or UDim2.new(0, 2, 0.5, -8)
...
local function createValueChanger(parent, text, values, value, callback, id)
    ...
    changerFrame.Size = UDim2.new(1, -8, 0, 28)
    ...
    local hoverEffectPrev = Instance.new("Frame")
    hoverEffectPrev.Size = UDim2.new(1, 0, 1, 0)
    hoverEffectPrev.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    hoverEffectPrev.BackgroundTransparency = 0.9
    hoverEffectPrev.Parent = prevButton
    hoverEffectPrev.Visible = false
    
    local hoverEffectNext = Instance.new("Frame")
    hoverEffectNext.Size = UDim2.new(1, 0, 1, 0)
    hoverEffectNext.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    hoverEffectNext.BackgroundTransparency = 0.9
    hoverEffectNext.Parent = nextButton
    hoverEffectNext.Visible = false
    
    prevButton.MouseEnter:Connect(function()
        hoverEffectPrev.Visible = true
        TweenService:Create(hoverEffectPrev, TweenInfo.new(0.15), {BackgroundTransparency = 0.8}):Play()
    end)
    
    prevButton.MouseLeave:Connect(function()
        TweenService:Create(hoverEffectPrev, TweenInfo.new(0.15), {BackgroundTransparency = 0.9}):Play()
        wait(0.15)
        hoverEffectPrev.Visible = false
    end)
    
    nextButton.MouseEnter:Connect(function()
        hoverEffectNext.Visible = true
        TweenService:Create(hoverEffectNext, TweenInfo.new(0.15), {BackgroundTransparency = 0.8}):Play()
    end)
    
    nextButton.MouseLeave:Connect(function()
        TweenService:Create(hoverEffectNext, TweenInfo.new(0.15), {BackgroundTransparency = 0.9}):Play()
        wait(0.15)
        hoverEffectNext.Visible = false
    end)
...
local function createColorButton(parent, text, value, callback, id)
    ...
    hoverEffect.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    hoverEffect.BackgroundTransparency = 0.9
    hoverEffect.Parent = colorButton
    hoverEffect.Visible = false
...
local function refreshConfigUI(scrollFrame)
    ...
    createConfigFrame.Size = UDim2.new(1, -8, 0, 60)
    ...
    hoverEffect.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    hoverEffect.BackgroundTransparency = 0.9
    hoverEffect.Parent = createButton
    hoverEffect.Visible = false
    ...
    for _, configName in ipairs(scanConfigs()) do
        ...
        configFrame.Size = UDim2.new(1, -8, 0, 50)
        ...
        local loadHover = Instance.new("Frame")
        loadHover.Size = UDim2.new(1, 0, 1, 0)
        loadHover.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        loadHover.BackgroundTransparency = 0.9
        loadHover.Parent = loadButton
        loadHover.Visible = false
        
        local deleteHover = Instance.new("Frame")
        deleteHover.Size = UDim2.new(1, 0, 1, 0)
        deleteHover.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        deleteHover.BackgroundTransparency = 0.9
        deleteHover.Parent = deleteButton
        deleteHover.Visible = false
        
        loadButton.MouseEnter:Connect(function()
            loadHover.Visible = true
            TweenService:Create(loadHover, TweenInfo.new(0.15), {BackgroundTransparency = 0.8}):Play()
        end)
        
        loadButton.MouseLeave:Connect(function()
            TweenService:Create(loadHover, TweenInfo.new(0.15), {BackgroundTransparency = 0.9}):Play()
            wait(0.15)
            loadHover.Visible = false
        end)
        ...
        deleteButton.MouseEnter:Connect(function()
            ...
            TweenService:Create(deleteHover, TweenInfo.new(0.15), {BackgroundTransparency = 0.8}):Play()
        end)
        
        deleteButton.MouseLeave:Connect(function()
            TweenService:Create(deleteHover, TweenInfo.new(0.15), {BackgroundTransparency = 0.9}):Play()
            wait(0.15)
            deleteHover.Visible = false
        end)
...
local function createMainGUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = i == 1 and UDim2.new(0, 26, 0, 26) or UDim2.new(0, 20, 0, 20)
        tabIcon.Position = i == 1 and UDim2.new(0.5, -13, 0.5, -13) or UDim2.new(0.5, -10, 0.5, -10)
