        ...
        safeCall(function()
            ...
            if success and result then
                ...
                if result.System then
                    ...
                    uiScale = settings.System.UIScale or 0.9
                end
            end
        end, "loadSettings")
    end
...
local function createSkeleton(character)
    ...
    for _, connection in ipairs(skeletonConnections) do
        ...
        line.Transparency = settings.Skeleton.Transparency
        line.ZIndex = 1
...
local function refreshConfigUI(scrollFrame)
    ...
    for _, configName in ipairs(scanConfigs()) do
        ...
        configFrame.Size = UDim2.new(1, -8, 0, 36 * uiScale)
...
local function createKeyGUI()
    ...
    generateButton.Position = UDim2.new(0.1, 0, 0, 115)
    ...
    submitButton.Position = UDim2.new(0.55, 0, 0, 115)
...
local function createMainGUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = UDim2.new(0, i == 1 and 18 or 14, 0, i == 1 and 18 or 14)
        tabIcon.Position = UDim2.new(0.5, i == 1 and -9 or -7, 0.5, i == 1 and -9 or -7)
...
local function init()
    ...
    RunService.RenderStepped:Connect(function()
        if activeTouch then
            ...
            blur.Size = UDim2.new(1, math.abs(velocity)*0.6, 1, math.abs(velocity)*0.6)
        else
