...
local function updateHitbox(character)
    ...
    if not hitboxCache[character] then
        ...
        if settings.Combat.Hitbox.Type == "Sphere" then
            ...
            box.Size = Vector3.new(settings.Combat.Hitbox.Size, settings.Combat.Hitbox.Size * 1.7, settings.Combat.Hitbox.Size)
        end
    ...
    if settings.Combat.Hitbox.Type == "Sphere" then
        ...
        hrp.Size = Vector3.new(settings.Combat.Hitbox.Size, settings.Combat.Hitbox.Size * 1.7, settings.Combat.Hitbox.Size)
    end
