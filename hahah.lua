...
local function createMainGUI()
    ...
    leftIcon.Position = isMinimized and UDim2.new(0.5, -42, 0.5, -8) or UDim2.new(0.5, -55, 0.5, -9)
    ...
    rightIcon.Position = isMinimized and UDim2.new(0.5, 22, 0.5, -8) or UDim2.new(0.5, 30, 0.5, -9)
