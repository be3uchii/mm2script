...
local function createCleanToggle(parent, text, value, callback, id)
    ...
    toggleFrame.Size = UDim2.new(1, -8, 0, 22 * uiScale)
    ...
    ToggleCircle.Size = UDim2.new(0, 12 * uiScale, 0, 12 * uiScale)
    ToggleCircle.Position = value and UDim2.new(1, -14 * uiScale, 0.5, -6 * uiScale) or UDim2.new(0, 2 * uiScale, 0.5, -6 * uiScale)
    ...
    SwitchButton.MouseButton1Click:Connect(function()
        ...
        local circleGoalPos = value and UDim2.new(1, -14 * uiScale, 0.5, -6 * uiScale) or UDim2.new(0, 2 * uiScale, 0.5, -6 * uiScale)
...
local function createValueChanger(parent, text, values, value, callback, id)
    ...
    changerFrame.Size = UDim2.new(1, -8, 0, 22 * uiScale)
    ...
    valueLabel.TextSize = 13 * uiScale
...
local function createColorButton(parent, text, value, callback, id)
    ...
    colorFrame.Size = UDim2.new(1, -8, 0, 20 * uiScale)
...
local function refreshConfigUI(scrollFrame)
    ...
    createConfigFrame.Size = UDim2.new(1, -8, 0, 50 * uiScale)
    ...
    createButton.TextSize = 13 * uiScale
    ...
    yOffset = yOffset + 55 * uiScale
    
    for _, configName in ipairs(scanConfigs()) do
        local configFrame = Instance.new("Frame")
        configFrame.Size = UDim2.new(1, -8, 0, 40 * uiScale)
        ...
        loadButton.TextSize = 13 * uiScale
        ...
        deleteButton.TextSize = 13 * uiScale
...
local function createKeyGUI()
    ...
    keyBox.Position = UDim2.new(0.1, 0, 0, 85)
    ...
    generateButton.Position = UDim2.new(0.1, 0, 0, 125)
    ...
    submitButton.Position = UDim2.new(0.55, 0, 0, 125)
...
local function createMainGUI()
    ...
    dragArea.TextSize = isMinimized and 16 or 18
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = UDim2.new(0, i == 1 and 20 or 16, 0, i == 1 and 20 or 16)
        tabIcon.Position = UDim2.new(0.5, i == 1 and -10 or -8, 0.5, i == 1 and -10 or -8)
        ...
        contentFrame.Position = UDim2.new(0, 4, 0, 65)
