...
local menuWidth, menuHeight = 250, 150
...
local minimizedPosition = UDim2.new(0.5, -35, 0, 15)
...
local function createCleanToggle(parent, text, value, callback, id)
    ...
    toggleFrame.Size = UDim2.new(1, -8, 0, 16)
...
local function createValueChanger(parent, text, values, value, callback, id)
    ...
    changerFrame.Size = UDim2.new(1, -8, 0, 16)
...
local function createColorButton(parent, text, value, callback, id)
    ...
    colorFrame.Size = UDim2.new(1, -8, 0, 14)
...
local function refreshConfigUI(scrollFrame)
    ...
    createConfigFrame.Size = UDim2.new(1, -8, 0, 40)
    ...
    for _, configName in ipairs(scanConfigs()) do
        ...
        configFrame.Size = UDim2.new(1, -8, 0, 30)
...
local function createMainGUI()
    ...
    icon.Position = UDim2.new(0.5, 40, 0.5, -7)
    icon.AnchorPoint = Vector2.new(0.5, 0.5)
    icon.BackgroundTransparency = 1
    icon.Image = "rbxassetid://12364715804"
    icon.ImageTransparency = 0.1
    icon.Parent = dragArea

    local tabContainer = Instance.new("Frame")
    tabContainer.Size = UDim2.new(1, 0, 0, 18)
    tabContainer.Position = UDim2.new(0, 0, 0, 18)
    ...
    for i, tabName in ipairs(tabs) do
        ...
        tabIcon.Size = i == 1 and UDim2.new(0, 18, 0, 18) or UDim2.new(0, 12, 0, 12)
        tabIcon.Position = i == 1 and UDim2.new(0.5, -9, 0.5, -9) or UDim2.new(0.5, -6, 0.5, -6)
        ...
        contentFrame.Size = UDim2.new(1, -8, 1, -40)
