...
local function refreshMusicUI()
    ...
    prevButton.Position = UDim2.new(0.25, -12, 0, 8)
    prevButton.BackgroundTransparency = 1
    ...
    playPauseButton.Size = UDim2.new(0, 24, 0, 24)
    playPauseButton.Position = UDim2.new(0.5, -12, 0, 8)
    ...
    nextButton.Position = UDim2.new(0.75, -12, 0, 8)
    nextButton.BackgroundTransparency = 1
