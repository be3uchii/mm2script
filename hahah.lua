...
local function updateHitbox(character)
    ...
    if not hitboxCache[character] then
        ...
        if settings.Combat.Hitbox.Type == "Sphere" then
            ...
            box.Size = Vector3.new(settings.Combat.Hitbox.Size, settings.Combat.Hitbox.Size * 2, settings.Combat.Hitbox.Size)
            box.AlwaysOnTop = false
        end
    ...
    hrp.Size = Vector3.new(settings.Combat.Hitbox.Size, settings.Combat.Hitbox.Size * 2, settings.Combat.Hitbox.Size)
    hrp.Transparency = 1
