...
local function ensureFolderStructure()
    local folders = {configFolder, backupFolder}
...
local function refreshConfigUI()
    ...
    configListFrame.Size = UDim2.new(1, -8, 0, 100)
    configListFrame.BackgroundTransparency = 1
    configListFrame.Position = UDim2.new(0, 4, 0, 0)
    configListFrame.Parent = configScrollFrame
    ...
    configLabel.Parent = configListFrame
    
    local configScrollingFrame = Instance.new("ScrollingFrame")
    configScrollingFrame.Size = UDim2.new(1, 0, 1, -20)
    configScrollingFrame.Position = UDim2.new(0, 0, 0, 20)
    configScrollingFrame.BackgroundTransparency = 1
    configScrollingFrame.BorderSizePixel = 0
    configScrollingFrame.ScrollBarThickness = 3
    configScrollingFrame.AutomaticCanvasSize = Enum.AutomaticSize.Y
    configScrollingFrame.Parent = configListFrame
    
    local configUIListLayout = Instance.new("UIListLayout")
    configUIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    configUIListLayout.Parent = configScrollingFrame
    ...
    local function refreshConfigList()
        ...
        for i, configName in ipairs(configs) do
            ...
            configButton.Size = UDim2.new(1, -4, 0, 25)
            configButton.Position = UDim2.new(0, 2, 0, (i-1)*30)
            configButton.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
            configButton.Text = configName
            configButton.TextColor3 = Color3.fromRGB(230, 230, 230)
            configButton.TextSize = 12
            configButton.Font = Enum.Font.Gotham
            configButton.LayoutOrder = i
            configButton.Parent = configScrollingFrame
            ...
            table.insert(configButtons, configButton)
        end
    end
    ...
    saveFrame.Size = UDim2.new(1, -8, 0, 25)
    saveFrame.BackgroundTransparency = 1
    saveFrame.Position = UDim2.new(0, 4, 0, 110)
    saveFrame.Parent = configScrollFrame
    
    local saveTextBox = Instance.new("TextBox")
    saveTextBox.Size = UDim2.new(0.7, 0, 1, 0)
    saveTextBox.Position = UDim2.new(0, 0, 0, 0)
    saveTextBox.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
    saveTextBox.TextColor3 = Color3.fromRGB(230, 230, 230)
    saveTextBox.PlaceholderText = "Config Name"
    saveTextBox.PlaceholderColor3 = Color3.fromRGB(150, 150, 150)
    saveTextBox.TextSize = 12
    saveTextBox.Font = Enum.Font.Gotham
    saveTextBox.Parent = saveFrame
    
    local corner = Instance.new("UICorner")
    corner.CornerRadius = UDim.new(0, 4)
    corner.Parent = saveTextBox
    
    local glow = Instance.new("UIStroke")
    glow.Color = Color3.fromRGB(60, 60, 255)
    glow.Thickness = 1
    glow.Transparency = 0.7
    glow.Parent = saveTextBox
    
    local saveButton = Instance.new("TextButton")
    saveButton.Size = UDim2.new(0.25, 0, 1, 0)
    ...
    corner2.Parent = saveButton
    
    local glow2 = Instance.new("UIStroke")
    glow2.Color = Color3.fromRGB(76, 217, 100)
    glow2.Thickness = 1
    glow2.Transparency = 0.7
    glow2.Parent = saveButton
    
    saveButton.MouseButton1Click:Connect(function()
        playSound()
        local configName = saveTextBox.Text:gsub("%s+", ""):gsub("[^%w_]", "")
        if configName ~= "" then
    ...
    backupButton.Size = UDim2.new(1, -8, 0, 25)
    backupButton.Position = UDim2.new(0, 4, 0, 145)
    backupButton.BackgroundColor3 = Color3.fromRGB(60, 60, 255)
    backupButton.Text = "Create Backup"
    backupButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    backupButton.TextSize = 12
    backupButton.Font = Enum.Font.GothamBold
    backupButton.Parent = configScrollFrame
    
    local corner3 = Instance.new("UICorner")
    corner3.CornerRadius = UDim.new(0, 4)
    corner3.Parent = backupButton
    
    local glow3 = Instance.new("UIStroke")
    glow3.Color = Color3.fromRGB(60, 60, 255)
    glow3.Thickness = 1
    glow3.Transparency = 0.7
    glow3.Parent = backupButton
    ...
    clearButton.Size = UDim2.new(1, -8, 0, 25)
    clearButton.Position = UDim2.new(0, 4, 0, 180)
    clearButton.BackgroundColor3 = Color3.fromRGB(255, 58, 58)
    clearButton.Text = "Clear All"
    clearButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    clearButton.TextSize = 12
    clearButton.Font = Enum.Font.GothamBold
    clearButton.Parent = configScrollFrame
    
    local corner4 = Instance.new("UICorner")
    corner4.CornerRadius = UDim.new(0, 4)
    corner4.Parent = clearButton
    
    local glow4 = Instance.new("UIStroke")
    glow4.Color = Color3.fromRGB(255, 58, 58)
    glow4.Thickness = 1
    glow4.Transparency = 0.7
    glow4.Parent = clearButton
...
local function createUI()
    ...
    for i, tabName in ipairs(tabs) do
        ...
        local glow = Instance.new("UIStroke")
        glow.Color = i == 1 and Color3.fromRGB(60, 60, 255) or Color3.fromRGB(50, 50, 60)
        glow.Thickness = 1
        glow.Transparency = 0.7
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for j, button in ipairs(tabButtons) do
                ...
                button.UIStroke.Color = j == i and Color3.fromRGB(60, 60, 255) or Color3.fromRGB(50, 50, 60)
            end
        end)
    ...
    connections.timer = RunService.RenderStepped:Connect(function(deltaTime)
        updateTimer()
