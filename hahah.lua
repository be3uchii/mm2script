...
local function createIconToggle(parent, text, value, callback, id)
    ...
    toggleButton.Image = value and "rbxassetid://11896855899" or "rbxassetid://11896842923"
    toggleButton.ImageColor3 = Color3.fromRGB(200, 200, 200)
    toggleButton.Parent = toggleFrame
    
    -- Create a container for the sliding animation
    local sliderContainer = Instance.new("Frame")
    sliderContainer.Size = UDim2.new(1, 0, 1, 0)
    sliderContainer.BackgroundTransparency = 1
    sliderContainer.ClipsDescendants = true
    sliderContainer.Parent = toggleButton
    
    -- Create both icons inside the container
    local onIcon = Instance.new("ImageLabel")
    onIcon.Size = UDim2.new(1, 0, 1, 0)
    onIcon.Position = UDim2.new(value and 0 or -1, 0, 0, 0)
    onIcon.BackgroundTransparency = 1
    onIcon.Image = "rbxassetid://11896855899"
    onIcon.ImageColor3 = Color3.fromRGB(76, 217, 100)
    onIcon.Parent = sliderContainer
    
    local offIcon = Instance.new("ImageLabel")
    offIcon.Size = UDim2.new(1, 0, 1, 0)
    offIcon.Position = UDim2.new(value and 1 or 0, 0, 0, 0)
    offIcon.BackgroundTransparency = 1
    offIcon.Image = "rbxassetid://11896842923"
    offIcon.ImageColor3 = Color3.fromRGB(255, 58, 58)
    offIcon.Parent = sliderContainer
    ...
    toggleButton.MouseButton1Click:Connect(function()
        ...
        if value then
            TweenService:Create(onIcon, tweenInfo, {Position = UDim2.new(0, 0, 0, 0), ImageColor3 = Color3.fromRGB(76, 217, 100)}):Play()
            TweenService:Create(offIcon, tweenInfo, {Position = UDim2.new(1, 0, 0, 0), ImageColor3 = Color3.fromRGB(255, 58, 58)}):Play()
        else
            TweenService:Create(onIcon, tweenInfo, {Position = UDim2.new(-1, 0, 0, 0), ImageColor3 = Color3.fromRGB(76, 217, 100)}):Play()
            TweenService:Create(offIcon, tweenInfo, {Position = UDim2.new(0, 0, 0, 0), ImageColor3 = Color3.fromRGB(255, 58, 58)}):Play()
        end
    ...
    if id then
        uiElements[id] = {
            update = function(newValue)
                value = newValue
                if value then
                    onIcon.Position = UDim2.new(0, 0, 0, 0)
                    offIcon.Position = UDim2.new(1, 0, 0, 0)
                    onIcon.ImageColor3 = Color3.fromRGB(76, 217, 100)
                    offIcon.ImageColor3 = Color3.fromRGB(255, 58, 58)
                else
                    onIcon.Position = UDim2.new(-1, 0, 0, 0)
                    offIcon.Position = UDim2.new(0, 0, 0, 0)
                    onIcon.ImageColor3 = Color3.fromRGB(76, 217, 100)
                    offIcon.ImageColor3 = Color3.fromRGB(255, 58, 58)
                end
            end
...
local function refreshCombatUI()
    ...
    createIconToggle(combatScrollFrame, "Hitbox Enabled", settings.Combat.Hitbox.Enabled, function(value)
    ...
    createIconToggle(combatScrollFrame, "Sphere Hitbox", settings.Combat.Hitbox.Type == "Sphere", function(value)
...
local function refreshESPUI()
    ...
    createIconToggle(espScrollFrame, "ESP Enabled", settings.ESP.Enabled, function(value)
        settings.ESP.Enabled = value
        updateAllESP()
    end, "espEnabled")
    
    createIconToggle(espScrollFrame, "Show Distance", settings.ESP.ShowDistance, function(value)
