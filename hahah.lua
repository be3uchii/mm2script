...
local function updateESP(player)
    ...
    box.Visible = settings.ESP.Enabled and settings.ESP.BoxEnabled
...
local function refreshESPUI()
    ...
    createCleanToggle(espScrollFrame, "Show Box", settings.ESP.BoxEnabled, function(value)
        ...
        loadButton.MouseButton1Click:Connect(function()
            ...
            if loadConfig(configName) then
                for id, element in pairs(uiElements) do
                    ...
                    elseif id == "espBoxEnabled" then
                        element.update(settings.ESP.BoxEnabled)
