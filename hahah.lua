...
local minimizedSize = UDim2.new(0, 100, 0, 28)
...
local function createCleanToggle(parent, text, value, callback, id)
    ...
    ToggleCircle.Position = value and UDim2.new(1, -15, 0.5, -6.5) or UDim2.new(0, 2, 0.5, -6.5)
    ...
    SwitchButton.MouseButton1Click:Connect(function()
        ...
        local circleGoalPos = value and UDim2.new(1, -15, 0.5, -6.5) or UDim2.new(0, 2, 0.5, -6.5)
...
local function refreshConfigUI(scrollFrame)
    ...
    createConfigFrame.Size = UDim2.new(1, -8, 0, 52)
    ...
    for _, configName in ipairs(scanConfigs()) do
        ...
        configFrame.Size = UDim2.new(1, -8, 0, 42)
...
local function createKeyGUI()
    ...
    generateButton.Size = UDim2.new(0.35, 0, 0, 32)
    generateButton.Position = UDim2.new(0.1, 0, 0, 130)
    ...
    submitButton.Size = UDim2.new(0.35, 0, 0, 32)
    submitButton.Position = UDim2.new(0.55, 0, 0, 130)
...
local function createMainGUI()
    ...
    dragArea.TextSize = isMinimized and 14 or 17
    ...
    rightIcon.Position = UDim2.new(0.5, 38, 0.5, -11)
