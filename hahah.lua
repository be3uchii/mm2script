...
local function updateHitbox(character)
    ...
    local newSize = Vector3.new(settings.Combat.Hitbox.Size, settings.Combat.Hitbox.Size, settings.Combat.Hitbox.Size)
    hrp.Size = newSize
    hrp.Transparency = 1
    ...
    if box then
        box.Size = Vector3.new(newSize.X * 1.5, newSize.Y * 2.5, newSize.Z * 1.5)
        box.Transparency = settings.Combat.Hitbox.Transparency
        box.Color3 = settings.Combat.Hitbox.Color
    end
