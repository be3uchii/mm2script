...
dragArea.TextColor3 = Color3.fromRGB(200, 220, 255)
dragArea.TextTransparency = 0.1
dragArea.TextSize = isMinimized and 14 or 18
...
for i = 1, maxParticles do
    ...
    particleStroke.Color = Color3.fromRGB(150, 200, 255)
    particleStroke.Thickness = 0.5
    particleStroke.Transparency = 0.3
    particleStroke.Parent = particle
    particles[i] = {frame = particle, velocity = Vector2.new(math.random(-3, 3) / 40, math.random(3, 6) / 30), alpha = math.random(20, 50) / 100}
end
...
local function updateParticles()
    ...
    for _, particle in ipairs(particles) do
        ...
        if newY > 1.5 or newX < -0.1 or newX > 1.1 then
            newX = math.random()
            newY = -0.1
            particle.velocity = Vector2.new(math.random(-3, 3) / 40, math.random(3, 6) / 30)
...
local function createToggle(parent, text, defaultValue, callback)
    ...
    toggle.MouseButton1Click:Connect(function()
        ...
        toggle.Text = defaultValue and "ВКЛ" or "ВЫКЛ"
        local targetColor = defaultValue and Color3.fromRGB(0, 200, 100) or Color3.fromRGB(200, 50, 50)
    ...
    toggle.MouseEnter:Connect(function()
        ...
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(150, 200, 255), Thickness = 2}):Play()
    end)
    
    toggle.MouseLeave:Connect(function()
        TweenService:Create(toggle, tweenInfo, {Size = UDim2.new(0.35, 0, 0.8, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(100, 150, 255), Thickness = 1.5}):Play()
    end)
...
local function createValueChanger(parent, text, values, defaultValueIndex, callback)
    ...
    prevButton.BackgroundColor3 = Color3.fromRGB(20, 30, 50)
    prevButton.Text = "<"
    prevButton.TextColor3 = Color3.fromRGB(200, 220, 255)
    ...
    nextButton.BackgroundColor3 = Color3.fromRGB(20, 30, 50)
    nextButton.Text = ">"
    nextButton.TextColor3 = Color3.fromRGB(200, 220, 255)
    ...
    prevButton.MouseEnter:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(40, 60, 90), Size = UDim2.new(0.13, 0, 0.82, 0)}):Play()
    end)
    
    prevButton.MouseLeave:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(20, 30, 50), Size = UDim2.new(0.12, 0, 0.8, 0)}):Play()
    end)
    
    nextButton.MouseEnter:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(40, 60, 90), Size = UDim2.new(0.13, 0, 0.82, 0)}):Play()
    end)
    
    nextButton.MouseLeave:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(20, 30, 50), Size = UDim2.new(0.12, 0, 0.8, 0)}):Play()
    end)
    ...
    if LocalPlayer.Character then
        for _, part in pairs(LocalPlayer.Character:GetDescendants()) do
            if part:IsA("BasePart") then
                part.CanCollide = not settings.Misc.NoClip and not settings.Combat.Hitbox.Enabled
...
for i, tabName in ipairs(tabs) do
    ...
    tabButton.BackgroundColor3 = i == currentTab and Color3.fromRGB(50, 80, 120) or Color3.fromRGB(20, 30, 50)
    ...
    tabStroke.Color = i == currentTab and Color3.fromRGB(100, 150, 255) or Color3.fromRGB(60, 80, 120)
    ...
    tabGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 80, 120)),
    ...
    contentFrame.BackgroundColor3 = Color3.fromRGB(15, 25, 40)
    ...
    contentStroke.Transparency = 0.15
    ...
    tabButton.MouseButton1Click:Connect(function()
        ...
        for j, btn in ipairs(tabButtons) do
            ...
            btn.BackgroundColor3 = isActive and Color3.fromRGB(50, 80, 120) or Color3.fromRGB(20, 30, 50)
            local stroke = btn:FindFirstChildOfClass("UIStroke")
            if stroke then
                stroke.Color = isActive and Color3.fromRGB(100, 150, 255) or Color3.fromRGB(60, 80, 120)
    ...
    tabButton.MouseEnter:Connect(function()
        if i ~= currentTab then
            TweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(30, 50, 80)}):Play()
        end
    end)
    
    tabButton.MouseLeave:Connect(function()
        if i ~= currentTab then
            TweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(20, 30, 50)}):Play()
        end
    end)
end
...
dragArea.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(dragArea, tweenInfo, {TextTransparency = isMinimized and 0.15 or 0.1, TextSize = isMinimized and 14 or 18}):Play()
end)
...
RunService:BindToRenderStep("MenuUpdate", Enum.RenderPriority.Input.Value + 1, function()
    ...
    for i, btn in ipairs(tabButtons) do
        local targetColor = i == currentTab and Color3.fromRGB(50, 80, 120) or Color3.fromRGB(20, 30, 50)
