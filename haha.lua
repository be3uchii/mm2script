...
for i = 1, maxParticles do
    ...
    particle.BackgroundColor3 = Color3.fromRGB	Date: Wed, 30 Oct 2024 10:02:59 GMT
    ...
    particles[i] = {frame = particle, velocity = Vector2.new(math.random(-2, 2) / 30, math.random(4, 8) / 25), alpha = math.random(20, 50) / 100}
end
...
local function updateParticles()
    ...
    for _, particle in ipairs(particles) do
        ...
        local newAlpha = particle.alpha + math.sin(tick() * 1.5 + newX * 8) * 0.1
...
local function createValueChanger(parent, text, values, defaultValueIndex, callback)
    ...
    prevButton.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
    prevButton.Text = "<"
    ...
    nextButton.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
    nextButton.Text = ">"
    ...
    prevButton.MouseEnter:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(40, 40, 60), Size = UDim2.new(0.105, 0, 0.82, 0)}):Play()
    end)
    
    prevButton.MouseLeave:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(20, 20, 30), Size = UDim2.new(0.1, 0, 0.8, 0)}):Play()
    end)
    
    nextButton.MouseEnter:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(40, 40, 60), Size = UDim2.new(0.105, 0, 0.82, 0)}):Play()
    end)
    
    nextButton.MouseLeave:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(20, 20, 30), Size = UDim2.new(0.1, 0, 0.8, 0)}):Play()
    end)
...
local function createColorButton(parent, text, defaultColor, callback)
    ...
    colorButton.MouseEnter:Connect(function()
        ...
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 120, 255), Thickness = 2.2}):Play()
    end)
    
    colorButton.MouseLeave:Connect(function()
        TweenService:Create(colorButton, tweenInfo, {Size = UDim2.new(0.3, 0, 0.8, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(80, 80, 255), Thickness = 2}):Play()
    end)
...
for i, tabName in ipairs(tabs) do
    ...
    tabButton.BackgroundColor3 = i == currentTab and Color3.fromRGB(80, 80, 100) or Color3.fromRGB(30, 30, 40)
    ...
    tabStroke.Transparency = i == currentTab and 0.1 or 0.2
    ...
    tabButton.MouseButton1Click:Connect(function()
        ...
        for j, btn in ipairs(tabButtons) do
            ...
            btn.BackgroundColor3 = isActive and Color3.fromRGB(80, 80, 100) or Color3.fromRGB(30, 30, 40)
            local stroke = btn:FindFirstChildOfClass("UIStroke")
            if stroke then
                stroke.Color = isActive and Color3.fromRGB(80, 80, 255) or Color3.fromRGB(60, 60, 80)
                stroke.Transparency = isActive and 0.1 or 0.2
    ...
    tabButton.MouseEnter:Connect(function()
        if i ~= currentTab then
            TweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(50, 50, 80)}):Play()
        end
    end)
...
dragArea.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(dragArea, tweenInfo, {TextTransparency = isMinimized and 0.15 or 0.1, TextSize = isMinimized and 12 or 16}):Play()
end)
...
RunService:BindToRenderStep("MenuUpdate", Enum.RenderPriority.Input.Value + 1, function()
    ...
    for i, btn in ipairs(tabButtons) do
        local targetColor = i == currentTab and Color3.fromRGB(80, 80, 100) or Color3.fromRGB(30, 30, 40)
        local targetTransparency = i == currentTab and 0.1 or 0.2
