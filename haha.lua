...
local function updateHitboxes()
    for player,data in pairs(hitboxParts) do
        if data then
    ...
    local function createHitbox(player)
        if player ~= LocalPlayer and player.Character then
            ...
            elseif hitboxParts[player] then
                hitboxParts[player].highlight:Destroy()
                hitboxParts[player].part:Destroy()
        ...
        for _,player in pairs(Players:GetPlayers()) do
            if player ~= LocalPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if hitboxParts[player] then
                    hitboxParts[player].part.CFrame = rootPart.CFrame
                    hitboxParts[player].highlight.Adornee = rootPart
                end
            end
        end
    end)
