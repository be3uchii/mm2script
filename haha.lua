...
local tweenInfo = TweenInfo.new(0.6, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut) -- Slower, smoother animations
...
mainFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25) -- Darker, sleeker background
...
uiStroke.Color = Color3.fromRGB(120, 120, 255) -- Vibrant accent color
...
dragArea.Text = "Enhanced UI"
dragArea.TextColor3 = Color3.fromRGB(200, 200, 200)
dragArea.TextTransparency = 0.3
dragArea.TextSize = isMinimized and 13 or 16
dragArea.Font = Enum.Font.Gotham -- Modern font
...
for i = 1, maxParticles do
    ...
    particle.Size = UDim2.new(0, 3, 0, 3) -- Slightly larger particles
    particle.BackgroundColor3 = Color3.fromRGB(150, 150, 255) -- Matching accent color
    ...
    particles[i] = {frame = particle, velocity = Vector2.new(math.random(-3, 3) / 20, math.random(5, 9) / 15), alpha = math.random(30, 60) / 100}
end
...
local function updateParticles()
    ...
    for _, particle in ipairs(particles) do
        ...
        local newAlpha = particle.alpha + math.sin(tick() * 1.5 + newX * 10) * 0.1
        newAlpha = math.clamp(newAlpha, 0.3, 0.6)
        if newY > 1.5 or newX < -0.1 or newX > 1.1 then
            newX = math.random()
            newY = -0.1
            particle.velocity = Vector2.new(math.random(-3, 3) / 20, math.random(5, 9) / 15)
...
local function createToggle(parent, text, defaultValue, callback)
    ...
    toggle.MouseEnter:Connect(function()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 180, 255)}):Play()
    end)
...
local function createValueChanger(parent, text, values, defaultValueIndex, callback)
    ...
    prevButton.MouseEnter:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(60, 60, 60)}):Play()
    end)
    
    prevButton.MouseLeave:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play()
    end)
    
    nextButton.MouseEnter:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(60, 60, 60)}):Play()
    end)
    
    nextButton.MouseLeave:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play()
    end)
...
local function createColorButton(parent, text, defaultColor, callback)
    ...
    colorButton.MouseEnter:Connect(function()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 180, 255), Thickness = 1.5}):Play()
    end)
    
    colorButton.MouseLeave:Connect(function()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 120, 255), Thickness = 1}):Play()
    end)
        ...
        for _, player in pairs(Players:GetPlayers()) do
            if player ~= LocalPlayer and player.Character then
                ...
                if humanoid and humanoidRootPart and humanoid.Health > 0 then
                    ...
                    humanoidRootPart.CanCollide = false -- Allow passing through
...
for i, tabName in ipairs(tabs) do
    ...
    tabButton.BackgroundColor3 = i == 1 and Color3.fromRGB(90, 90, 90) or Color3.fromRGB(50, 50, 50)
    ...
    tabStroke.Color = i == currentTab and Color3.fromRGB(120, 120, 255) or Color3.fromRGB(100, 100, 100)
    tabStroke.Thickness = 1.5
    tabStroke.Transparency = i == currentTab and 0.2 or 0.5
    ...
    tabButton.MouseButton1Click:Connect(function()
        ...
        for j, btn in ipairs(tabButtons) do
            local targetStrokeColor = j == currentTab and Color3.fromRGB(120, 120, 255) or Color3.fromRGB(100, 100, 100)
            local targetStrokeTransparency = j == currentTab and 0.2 or 0.5
            local stroke = btn:FindFirstChildOfClass("UIStroke")
            if stroke then
                TweenService:Create(stroke, tweenInfo, {Color = targetStrokeColor, Transparency = targetStrokeTransparency}):Play()
            end
        end
    end)
    
    tabButton.MouseEnter:Connect(function()
        TweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(110, 110, 110)}):Play()
    end)
    
    tabButton.MouseLeave:Connect(function()
        local targetColor = i == currentTab and Color3.fromRGB(90, 90, 90) or Color3.fromRGB(50, 50, 50)
        TweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = targetColor}):Play()
    end)
end
...
dragArea.MouseButton1Click:Connect(function()
    ...
    local targetTransparency = isMinimized and 0.4 or 0.2
    ...
    TweenService:Create(dragArea, tweenInfo, {TextTransparency = isMinimized and 0.4 or 0.3, TextSize = isMinimized and 13 or 16}):Play()
end)
