...
local RunService = game:GetService(" OldPlayer = game:GetService("Players")
local UserInputService = game:GetService("UserInputService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Lighting = game:GetService("Lighting")
local LocalPlayer = OldPlayer.LocalPlayer
...
local minimizedPosition = UDim2.new(0.5, -50, 0, 10)
...
uiStroke.Color = Color3.fromRGB(120, 160, 255)
...
dragArea.TextColor3 = Color3.fromRGB(220, 230, 255)
dragArea.TextTransparency = 0.1
dragArea.TextSize = isMinimized and 16 or 20
...
for i = 1, maxParticles do
    ...
    particle.BackgroundColor3 = Color3.fromRGB(120, 160, 255)
    particle.BackgroundTransparency = math.random(15, 45) / 100
    ...
    particleStroke.Color = Color3.fromRGB(180, 220, 255)
    particleStroke.Thickness = 0.8
    particleStroke.Transparency = 0.2
    particleStroke.Parent = particle
    particles[i] = {frame = particle, velocity = Vector2.new(math.random(-4, 4) / 50, math.random(3, 7) / 35), alpha = math.random(15, 45) / 100}
end
...
local function updateParticles()
    ...
    if tick() - lastParticleUpdate < 0.066 then
        return
    end
    ...
    for _, particle in ipairs(particles) do
        ...
        local newAlpha = particle.alpha + math.sin(tick() * 2 + newX * 12) * 0.12
        newAlpha = math.clamp(newAlpha, 0.15, 0.45)
        if newY > 1.5 or newX < -0.1 or newX > 1.1 then
            newX = math.random()
            newY = -0.1
            particle.velocity = Vector2.new(math.random(-4, 4) / 50, math.random(3, 7) / 35)
            particle.alpha = math.random(15, 45) / 100
        end
...
local function createToggle(parent, text, defaultValue, callback)
    ...
    toggle.Size = UDim2.new(0.4, 0, 0.85, 0)
    toggle.Position = UDim2.new(0.6, 0, 0.075, 0)
    toggle.BackgroundColor3 = defaultValue and Color3.fromRGB(0, 220, 120) or Color3.fromRGB(220, 60, 60)
    ...
    toggle.MouseButton1Click:Connect(function()
        ...
        toggle.Text = defaultValue and "ВКЛ" or "ВЫКЛ"
        local targetColor = defaultValue and Color3.fromRGB(0, 220, 120) or Color3.fromRGB(220, 60, 60)
        local targetTransparency = defaultValue and 0.1 or 0.2
        TweenService:Create(toggle, tweenInfo, {BackgroundColor3 = targetColor, Size = UDim2.new(0.4, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Transparency = targetTransparency}):Play()
        callback(defaultValue)
    end)
    
    toggle.MouseEnter:Connect(function()
        TweenService:Create(toggle, tweenInfo, {Size = UDim2.new(0.41, 0, 0.87, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 220, 255), Thickness = 2.5}):Play()
    end)
    
    toggle.MouseLeave:Connect(function()
        TweenService:Create(toggle, tweenInfo, {Size = UDim2.new(0.4, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 160, 255), Thickness = 2}):Play()
    end)
...
local function createValueChanger(parent, text, values, defaultValueIndex, callback)
    ...
    changerFrame.Size = UDim2.new(1, -12, 0, 28)
    changerFrame.BackgroundTransparency = 1
    changerFrame.Position = UDim2.new(0, 6, 0, 0)
    ...
    prevButton.Size = UDim2.new(0.13, 0, 0.85, 0)
    prevButton.Position = UDim2.new(0.75, 0, 0.075, 0)
    prevButton.BackgroundColor3 = Color3.fromRGB(25, 35, 60)
    prevButton.Text = "<"
    prevButton.TextColor3 = Color3.fromRGB(220, 230, 255)
    prevButton.TextSize = 13
    prevButton.Font = Enum.Font.GothamBlack
    prevButton.Parent = changerFrame
    
    local nextButton = Instance.new("TextButton")
    nextButton.Size = UDim2.new(0.13, 0, 0.85, 0)
    nextButton.Position = UDim2.new(0.87, 0, 0.075, 0)
    nextButton.BackgroundColor3 = Color3.fromRGB(25, 35, 60)
    nextButton.Text = ">"
    nextButton.TextColor3 = Color3.fromRGB(220, 230, 255)
    ...
    prevButton.MouseEnter:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(45, 65, 90), Size = UDim2.new(0.14, 0, 0.87, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 220, 255), Thickness = 2.5}):Play()
    end)
    
    prevButton.MouseLeave:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(25, 35, 60), Size = UDim2.new(0.13, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 160, 255), Thickness = 2}):Play()
    end)
    
    nextButton.MouseEnter:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(45, 65, 90), Size = UDim2.new(0.14, 0, 0.87, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 220, 255), Thickness = 2.5}):Play()
    end)
    
    nextButton.MouseLeave:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(25, 35, 60), Size = UDim2.new(0.13, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 160, 255), Thickness = 2}):Play()
    end)
...
local function createColorButton(parent, text, defaultColor, callback)
    ...
    colorFrame.Position = UDim2.new(0, 6, 0, 0)
    ...
    colorButton.Size = UDim2.new(0.4, 0, 0.85, 0)
    colorButton.Position = UDim2.new(0.6, 0, 0.075, 0)
    ...
    colorButton.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(colorButton, tweenInfo, {BackgroundColor3 = colors[currentColorIndex], Size = UDim2.new(0.4, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = colors[currentColorIndex], Thickness = 2.5}):Play()
        callback(colors[currentColorIndex])
    end)
    
    colorButton.MouseEnter:Connect(function()
        TweenService:Create(colorButton, tweenInfo, {Size = UDim2.new(0.41, 0, 0.87, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 220, 255), Thickness = 2.5}):Play()
    end)
    
    colorButton.MouseLeave:Connect(function()
        TweenService:Create(colorButton, tweenInfo, {Size = UDim2.new(0.4, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 160, 255), Thickness = 2}):Play()
    end)
...
local function createTransparencySlider(parent, text, defaultValue, callback)
    ...
    sliderFrame.Position = UDim2.new(0, 6, 0, 0)
    ...
    local prevButton = Instance.new("TextButton")
    prevButton.Size = UDim2.new(0.15, 0, 0.85, 0)
    prevButton.Position = UDim2.new(0.55, 0, 0.075, 0)
    prevButton.BackgroundColor3 = Color3.fromRGB(25, 35, 60)
    prevButton.Text = "<"
    prevButton.TextColor3 = Color3.fromRGB(220, 230, 255)
    prevButton.TextSize = 13
    ...
    local nextButton = Instance.new("TextButton")
    nextButton.Size = UDim2.new(0.15, 0, 0.85, 0)
    ...
    prevButton.MouseEnter:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(45, 65, 90), Size = UDim2.new(0.16, 0, 0.87, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 220, 255), Thickness = 2.5}):Play()
    end)
    
    prevButton.MouseLeave:Connect(function()
        TweenService:Create(prevButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(25, 35, 60), Size = UDim2.new(0.15, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 160, 255), Thickness = 2}):Play()
    end)
    
    nextButton.MouseEnter:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(45, 65, 90), Size = UDim2.new(0.16, 0, 0.87, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(180, 220, 255), Thickness = 2.5}):Play()
    end)
    
    nextButton.MouseLeave:Connect(function()
        TweenService:Create(nextButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(25, 35, 60), Size = UDim2.new(0.15, 0, 0.85, 0)}):Play()
        TweenService:Create(stroke, tweenInfo, {Color = Color3.fromRGB(120, 160, 255), Thickness = 2}):Play()
    end)
...
local function updateHitboxes()
    ...
    if not settings.Combat.Hitbox.Enabled then
        for _, player in pairs(OldPlayer:GetPlayers()) do
    ...
    connections.HitboxCheck = RunService.Heartbeat:Connect(function()
        if tick() - (connections.HitboxLastCheck or 0) < 0.3 then return end
...
local function updateESP()
    ...
    connections.ESPCheck = RunService.Heartbeat:Connect(function()
        if tick() - (connections.ESPLastCheck or 0) < 0.3 then return end
...
for i, tabName in ipairs(tabs) do
    ...
    tabButton.Position = UDim2.new((i - 1) / #tabs, 2.5, 0, 2.5)
    tabButton.BackgroundColor3 = i == currentTab and Color3.fromRGB(60, 90, 140) or Color3.fromRGB(25, 35, 60)
    ...
    tabStroke.Color = i == currentTab and Color3.fromRGB(120, 160, 255) or Color3.fromRGB(70, 90, 130)
    ...
    tabGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(60, 90, 140)),
    ...
    contentFrame.BackgroundColor3 = Color3.fromRGB(12, 20, 45)
    ...
    contentStroke.Color = Color3.fromRGB(120, 160, 255)
    ...
    scrollFrame.ScrollBarImageColor3 = Color3.fromRGB(120, 160, 255)
    ...
    tabButton.MouseButton1Click:Connect(function()
        ...
        for j, btn in ipairs(tabButtons) do
            ...
            btn.BackgroundColor3 = isActive and Color3.fromRGB(60, 90, 140) or Color3.fromRGB(25, 35, 60)
            local stroke = btn:FindFirstChildOfClass("UIStroke")
            if stroke then
                stroke.Color = isActive and Color3.fromRGB(120, 160, 255) or Color3.fromRGB(70, 90, 130)
    ...
    tabButton.MouseEnter:Connect(function()
        if i ~= currentTab then
            TweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(35, 50, 80)}):Play()
            TweenService:Create(tabStroke, tweenInfo, {Color = Color3.fromRGB(180, 220, 255), Thickness = 2.5}):Play()
        end
    end)
    
    tabButton.MouseLeave:Connect(function()
        if i ~= currentTab then
            TweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(25, 35, 60)}):Play()
            TweenService:Create(tabStroke, tweenInfo, {Color = Color3.fromRGB(70, 90, 130), Thickness = 2}):Play()
        end
    end)
end
...
dragArea.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(dragArea, tweenInfo, {TextTransparency = isMinimized and 0.15 or 0.1, TextSize = isMinimized and 16 or 20}):Play()
end)
...
OldPlayer.PlayerAdded:Connect(function(player)
...
OldPlayer.PlayerRemoving:Connect(function(player)
...
RunService:BindToRenderStep("MenuUpdate", Enum.RenderPriority.Input.Value + 1, function()
    ...
    for i, btn in ipairs(tabButtons) do
        local targetColor = i == currentTab and Color3.fromRGB(60, 90, 140) or Color3.fromRGB(25, 35, 60)
