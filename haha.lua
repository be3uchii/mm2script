...
local function updateHitbox(character)
    ...
    local sizeMultiplier = settings.Combat.Hitbox.SizeMultiplier
    local baseSize = settings.Combat.Hitbox.Size
    ...
    if not hitboxCache[character] then
        ...
        box.ZIndex = 0
        box.Size = Vector3.new(baseSize * sizeMultiplier, baseSize * sizeMultiplier * 1.5, baseSize * sizeMultiplier)
        ...
        hrp:GetPropertyChangedSignal("Size"):Connect(function()
            if hitboxCache[character] then
                hitboxCache[character].Size = Vector3.new(baseSize * sizeMultiplier, baseSize * sizeMultiplier * 1.5, baseSize * sizeMultiplier)
            end
        end)
    end
    
    hrp.Size = Vector3.new(baseSize, baseSize, baseSize)
    hrp.Transparency = 1
