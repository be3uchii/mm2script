...
-- Scroll Frames for Tabs
local tabs = {"Trolling", "Cheats", "Animations", "Visuals"}
local scrollFrames = {}
...
for _, tabName in ipairs(tabs) do
    ...
    scrollFrames[tabName] = scrollFrame

    tabButton.MouseButton1Click:Connect(function()
        for _, frame in pairs(scrollFrames) do
            frame.Visible = false
        end
        scrollFrames[tabName].Visible = true
        currentTab = tabName
...
-- Set default tab
scrollFrames["Trolling"].Visible = true
currentTab = "Trolling"
...
local function createButton(tab, name, text, callback)
    ...
    button.Parent = scrollFrames[tab]
    local corner = Instance.new("UICorner")
    corner.CornerRadius = UDim.new(0, 8)
    ...
    button.MouseEnter:Connect(function()
        TweenService:Create(button, TweenInfo.new(0.2), {BackgroundTransparency = 0, TextSize = 20}):Play()
        local sound = Instance.new("Sound")
        sound.SoundId = "rbxassetid://9119348206"
        sound.Parent = button
        sound:Play()
    ...
    button.MouseLeave:Connect(function()
        TweenService:Create(button, TweenInfo.new(0.2), {BackgroundTransparency = 0.2, TextSize = 18}):Play()
    end)
...
local toggles = {}
local function createToggle(tab, name, text, callback)
    local toggleFrame = Instance.new("Frame")
    toggleFrame.Size = UDim2.new(1, -10, 0, 40)
    toggleFrame.BackgroundTransparency = 1
    toggleFrame.Parent = scrollFrames[tab]
    local toggleButton = Instance.new("TextButton")
