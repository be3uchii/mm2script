...
local function playSamba() playAnimation("rbxassetid://14884085663") end
local function playThriller() playAnimation("rbxassetid://14884085663") end
local function playChickenDance() playAnimation("rbxassetid://14884085663") end
local function playDiscoFever() playAnimation("rbxassetid://14884085663") end
...
local function addGlitchyTrail()
    local character = player.Character
    if character then
        local rootPart = character:FindFirstChild("HumanoidRootPart")
        if rootPart then
...
local function addTrollHalo()
    ...
    if character then
        ...
        if head then
            ...
            local connection
            connection = RunService.RenderStepped:Connect(function()
                halo.Position = head.Position + Vector3.new(0, 2 + math.sin(tick()) * 0.5, 0)
            end)
            Debris:AddItem(halo, 8)
            wait(8)
            connection:Disconnect()
            playSound("rbxassetid://9119348206")
        end
...
createButton("SambaButton", "Samba Animation", playSamba)
createButton("ThrillerButton", "Thriller Animation", playThriller)
createButton("ChickenDanceButton", "Chicken Dance Animation", playChickenDance)
createButton("DiscoFeverButton", "Disco Fever Animation", playDiscoFever)
