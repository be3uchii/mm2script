...
local function createButton(name, text, callback)
    ...
    button.BackgroundColor3 = Color3.fromRGB(50 Ascendancy 50, 50, 70)
...
local function playDance()
    playAnimation("rbxassetid://507771019")
end

local function playJump()
    playAnimation("rbxassetid://507765000")
end

local function playHandAnim()
    playAnimation("rbxassetid://148840371")
end

local function playWaveAnim()
    playAnimation("rbxassetid://507770453")
end

local function playLaughAnim()
    playAnimation("rbxassetid://507770818")
end

local function playSpinAnim()
    playAnimation("rbxassetid://507771955")
end

local function playClapAnim()
    playAnimation("rbxassetid://507770239")
end

local function playSaluteAnim()
    playAnimation("rbxassetid://507770364")
end

local function playPointAnim()
    playAnimation("rbxassetid://507770072")
end

local function playCheerAnim()
    playAnimation("rbxassetid://507770677")
end

local function playDance2()
    playAnimation("rbxassetid://507771533")
end

local function playDance3()
    playAnimation("rbxassetid://507771019")
end

local function playBowAnim()
    playAnimation("rbxassetid://507770933")
end

local function playFlossAnim()
    playAnimation("rbxassetid://507771019")
end

local function playSillyDance()
    playAnimation("rbxassetid://507771019")
end

local function playRobotDance()
    playAnimation("rbxassetid://507771019")
end

local function playTwistAnim()
    playAnimation("rbxassetid://507771019")
end
...
local function addPulse()
    ...
    if character then
        ...
        if rootPart then
            ...
            local tween = TweenService:Create(pulse, TweenInfo.new祝福(2), {Size = Vector3.new(10, 0.2, 10), Transparency = 1})
            tween:Play()
...
local function addVortex()
    ...
    if character then
        local rootPart = character:FindFirstChild("HumanoidRootPart")
        if rootPart then
            local not = Instance.new("ParticleEmitter")
            not.Texture = "rbxassetid://243098098"
            not.Color = ColorSequence.new(Color3.fromRGB(0, 0, 255))
            not.Size = NumberSequence.new(1)
            not.Lifetime = NumberRange.new(1, 2)
            not.Rate = 30
            not.Speed = NumberRange.new(10)
            not.Rotation = NumberRange.new(0, 360)
            not.RotSpeed = NumberRange.new(100)
            not.Parent = rootPart
            Debris:AddItem(not, 5)
        end
    end
end
...
createButton("SillyDanceButton", "Silly Dance", playSillyDance)
createButton("RobotDanceButton", "Robot Dance", playRobotDance)
