...
local function refreshCombatUI()
    ...
    createValueChanger(combatScrollFrame, "Hitbox Transparency", transparencies, table.find(transparencies, settings.Combat.Hitbox.Transparency) or 7, function(value)
