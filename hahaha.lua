...
local function createValueChanger(parent, text, values, value, callback)
...
local function createColorButton(parent, text, value, callback)
...
local function refreshCombatUI()
    ...
    local hitboxToggleFrame, hitboxToggle = createToggle(combatScrollFrame, "Hitbox Enabled", settings.Combat.Hitbox.Enabled, function(value)
        settings.Combat.Hitbox.Enabled = value
        hitboxToggle.Text = value and "ON" or "OFF"
        hitboxToggle.BackgroundColor3 = value and Color3.fromRGB(0, 230, 0) or Color3.fromRGB(230, 0, 0)
        if not value then
            clearHitboxes()
        end
        updateAllESP()
    ...
    local sizeChangerFrame, sizeLabel = createValueChanger(combatScrollFrame, "Hitbox Size", sizeValues, settings.Combat.Hitbox.Size, function(value)
        settings.Combat.Hitbox.Size = value
        sizeLabel.Text = tostring(value)
        updateAllESP()
    end)
    
    local sphereToggleFrame, sphereToggle = createToggle(combatScrollFrame, "Sphere Hitbox", settings.Combat.Hitbox.Type == "Sphere", function(value)
        settings.Combat.Hitbox.Type = value and "Sphere" or "Box"
        sphereToggle.Text = value and "ON" or "OFF"
        sphereToggle.BackgroundColor3 = value and Color3.fromRGB(0, 230, 0) or Color3.fromRGB(230, 0, 0)
        clearHitboxes()
        updateAllESP()
    end)
    
    local wallsToggleFrame, wallsToggle = createToggle(combatScrollFrame, "Through Walls", settings.Combat.Hitbox.ThroughWalls, function(value)
        settings.Combat.Hitbox.ThroughWalls = value
        wallsToggle.Text = value and "ON" or "OFF"
        wallsToggle.BackgroundColor3 = value and Color3.fromRGB(0, 230, 0) or Color3.fromRGB(230, 0, 0)
        updateAllESP()
    end)
    
    local colorFrame, colorButton = createColorButton(combatScrollFrame, "Hitbox Color", settings.Combat.Hitbox.Color, function(value)
        settings.Combat.Hitbox.Color = value
        colorButton.BackgroundColor3 = value
        updateAllESP()
    end)
    
    local transChangerFrame, transLabel = createValueChanger(combatScrollFrame, "Hitbox Transparency", transparencies, settings.Combat.Hitbox.Transparency, function(value)
        settings.Combat.Hitbox.Transparency = value
        transLabel.Text = tostring(value)
        updateAllESP()
    end)
end
...
local function refreshESPUI()
    ...
    local espToggleFrame, espToggle = createToggle(espScrollFrame, "ESP Enabled", settings.ESP.Enabled, function(value)
        settings.ESP.Enabled = value
        espToggle.Text = value and "ON" or "OFF"
        espToggle.BackgroundColor3 = value and Color3.fromRGB(0, 230, 0) or Color3.fromRGB(230, 0, 0)
        updateAllESP()
    end)
    
    local distanceToggleFrame, distanceToggle = createToggle(espScrollFrame, "Show Distance", settings.ESP.ShowDistance, function(value)
        settings.ESP.ShowDistance = value
        distanceToggle.Text = value and "ON" or "OFF"
        distanceToggle.BackgroundColor3 = value and Color3.fromRGB(0, 230, 0) or Color3.fromRGB(230, 0, 0)
        updateAllESP()
    end)
end
