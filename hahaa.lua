...
local function createTransparencyButton(parent, text, defaultValue, callback)
...
for i, tabName in ipairs(tabs) do
    ...
    if tabName == "Combat" then
        ...
        createTransparencyButton(scrollFrame, "Прозрачность Хитбокса", settings.Combat.Hitbox.Transparency, function(value)
    ...
    elseif tabName == "ESP" then
        ...
        createTransparencyButton(scrollFrame, "Прозрачность ESP", settings.ESP.Transparency, function(value)
