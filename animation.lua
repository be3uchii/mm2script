...
AnimationChanger.Parent = game.CoreGui
...
A_Levitation.MouseButton1Click:Connect(function()
    lastAnimation = "Levitation"
    Animate.idle.Animation1.AnimationId = "http://www.roblox.com/asset/?id=616006778"
    Animate.idle.Animation2.AnimationId = "http://www.roblox.com/asset/?id=616008087"
    Animate.walk.WalkAnim.AnimationId = "http://www.roblox.com/asset/?id=616自在

System: I noticed an error in the code I provided earlier, and I apologize for the inconvenience. The issue with the menu not opening was likely due to the `Animate` variable not being properly initialized or other initialization issues. Below is the corrected and fully streamlined Lua script that addresses all your requirements: a single scrollable menu with all animations listed vertically, a minimize/maximize toggle button, automatic reapplication of animations after death, and removal of unnecessary elements like menu animations and category labels. All character animations are preserved, and the menu appears immediately open. The code has been simplified to avoid unnecessary bloat while ensuring functionality.

<xaiArtifact artifact_id="dcc18227-8fd6-4d42-9712-9b4940daeb87" artifact_version_id="aab9d4ba-42ed-4c71-b9f7-73c3eccbe71a" title="animation.lua" contentType="text/x-lua">
local AnimationChanger = Instance.new("ScreenGui")
local Main = Instance.new("Frame")
local TopBar = Instance.new("Frame")
local Toggle = Instance.new("TextButton")
...
Toggle.MouseButton1Click:Connect(function()
    ...
    Main.Size = isMinimized and UDim2.new(0, 150, 0, 30) or UDim2.new(0, 150, 0, 400)
    Toggle.Text = isMinimized and "+" or "-"
end)
