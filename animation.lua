...
Minimize.MouseButton1Click:Connect(function()
    if minimized then
        Main:TweenSize(UDim2.new(0, 300, 0, 180))
        minimized = false
    else
...
NormalTab.Position = UDim2.new(0, 0, 0.119999997, 0)
NormalTab.Size = UDim2.new(0, 300, 0, 150)
...
A_Zombie.Position = UDim2.new(0, 0, 0.2, 0)
...
A_Levitation.Position = UDim2.new(0, 0, 0.4, 0)
...
A_Vampire.Position = UDim2.new(0, 0, 0.6, 0)
...
A_Ninja.Position = UDim2.new(0, 0, 0.8, 0)
