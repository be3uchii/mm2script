...
Tab.Position = UDim2.new(0, 0, 0, 32)
Tab.Size = UDim2.new(1, 0, 0, 248)
...
Category.Size = UDim2.new(1, 0, 0, 28)
...
Buttons.Position = UDim2.new(0, 5, 0, 34)
Buttons.Size = UDim2.new(1, -10, 1, -64)
...
StatsFrame.Position = UDim2.new(0, 0, 1, -28)
StatsFrame.Size = UDim2.new(1, 0, 0, 28)
...
ResetButton.Position = UDim2.new(0, 5, 1, -28)
ResetButton.Size = UDim2.new(0, 60, 0, 24)
...
PreviewFrame.Position = UDim2.new(1, 5, 0, 32)
PreviewFrame.Size = UDim2.new(0, 150, 0, 100)
...
local function toggleMenu()
    ...
    local targetSize = minimized and UDim2.new(0, 200, 0, 32) or UDim2.new(0, 200, 0, 280)
    ...
    local rotateTween = TweenService:Create(Minimize, TweenInfo.new(0.3), {Rotation = minimized and 180 or 0})
    rotateTween:Play()
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    ...
    if input.UserInputType == Enum.UserInputType.Touch and input.UserInputState == Enum.UserInputState.End then
        if not AnimationChanger.Enabled then
